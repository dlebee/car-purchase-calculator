      ...
      <div className="mt-1 space-y-0.5">
        ...
        {car.notes && (
          <div className="text-[10px] mt-1 pt-1 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="text-gray-900 dark:text-white break-words overflow-wrap-anywhere whitespace-pre-wrap mt-0.5" style={{ wordBreak: 'break-word', overflowWrap: 'break-word' }}>{car.notes}</div>
          </div>
        )}
      </div>
    </div>
